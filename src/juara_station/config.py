...
class LocationConfig:
    latitude: float = -17.10211
    longitude: float = -56.94487
    country: str = "BRA"
...
class StorageConfig:
    ...
    photo_date_subdirs: bool = False
    require_usb: bool = False
    csv_filename: str = "Jaguar Reserve Camera Trap.csv"
    csv_profile: str = "jaguar_reserve_camera_trap"
...
class SensorConfig:
    ...
    uart_co2_device: str | None = "/dev/serial0"
...
class TimeConfig:
    ...
    fallback_latitude: float = -17.10211
    fallback_longitude: float = -56.94487
...
class CameraModeConfig:
    ...
    exposure_value: float = -0.3
    exposure_us: int | None = None
    analogue_gain: float | None = None
    awb_mode: str = "auto"
    denoise: str = "cdn_fast"
    max_exposure_us: int = 50000
...
class CameraConfig:
    ...
    height: int = 1944
    jpeg_quality: int = 92
    scheduled_capture_times: list[str] = field(default_factory=lambda: ["09:00", "16:00"])
    warmup_seconds: float = 2.0
    capture_timeout_seconds: float = 12.0
    day: CameraModeConfig = field(default_factory=CameraModeConfig)
