...
def build_species_list_from_pack(
    ...
    *,
    ...
    # Regions are useful metadata, but unioning all species from a broad region
    # makes local deployments far too permissive.
